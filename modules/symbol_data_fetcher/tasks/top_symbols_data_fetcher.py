...
def run_top_symbols_data_fetcher(general_config_path, general_config_scheme_path):
...
if __name__ == "__main__":
    ...
    run_top_symbols_data_fetcher(paths["full_config_path"], paths["full_config_schema_path"])
