...
def sentiment_analyzer(all_symbols, history_config, history_entries, sentiment_entries):
    ...
    print(f"\n✅ History Sentiment Analysis complete")
...
if __name__ == "__main__":
    ...
    sentiment_data = sentiment_analyzer(all_symbols, history_config, history_entries, sentiment_entries)
